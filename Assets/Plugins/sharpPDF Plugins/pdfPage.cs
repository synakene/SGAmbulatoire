...
//		}
        ...
        /// <summary>
        /// Method that adds a header table to the page object
        /// </summary>
        /// <param name="newTable"></param>
        /// <param name="x">X position of the header table in the page</param>
        /// <param name="y">Y position of the header table in the page</param>
        public void addHeader(pdfTable newTable, int x, int y)
        {
        ...
        public void addSuccessTable(pdfDocument myDoc, List<pdfPage> pages, pdfTable newTable, int x, int y, int nextPageHeight, pdfTable copyTable)
        {
            ...
            int rowHeight = copyTable.rowStyle.fontSize + (copyTable.cellpadding * 2);
            ...
            for (i = 0; i < newTable.rowsCount; i++)
            {
                ...
                for (j = 0; j < copyTable[i].columnsCount; j++)
                {
                    ...
                    if (hSize < textList.Count)
                        hSize = textList.Count;
                }
        ...
        /// </summary>
        /// <param name="myDoc">The document object</param>
        ...
        /// <param name="nextPageHeight">The Y position of the table for pages > 1</param>
        public void addTable(pdfDocument myDoc, List<pdfPage> pages, pdfTable newTable, int x, int y, int nextPageHeight)
        {
            int headerHeight = newTable.tableHeaderStyle.fontSize + (newTable.cellpadding * 2);
        ...
        /// <param name="x">X position of the table in the page</param>
        /// <param name="y">Y position of the table in the page</param>
        public void OldAddTable(pdfTable newTable, int x, int y)
        {
            int headerHeight = newTable.tableHeaderStyle.fontSize + (newTable.cellpadding * 2);
            int rowHeight = newTable.rowStyle.fontSize + (newTable.cellpadding * 2);
            int tableWidth = newTable.borderSize;
