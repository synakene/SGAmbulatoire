...
namespace sharpPDF
{
	...
	public class pdfTable : IEnumerable
	{
		...
		{			
			...
			_tableHeaderStyle = new pdfTableRowStyle(predefinedFont.csHelvetica, 10, new pdfColor(predefinedColor.csBlack), new pdfColor(predefinedColor.csWhite), new pdfColor(predefinedColor.csBlack));
			_rowStyle = new  pdfTableRowStyle(predefinedFont.csHelvetica, 10, new pdfColor(predefinedColor.csBlack), new pdfColor(predefinedColor.csWhite), new pdfColor(predefinedColor.csBlack));
