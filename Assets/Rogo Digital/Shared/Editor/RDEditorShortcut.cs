...
namespace RogoDigital {
	public class RDEditorShortcut {
		...
		public static RDEditorShortcut[] Deserialize (string prefix, Action[] actions) {
			return Deserialize(prefix, actions, null);
		}

		public static RDEditorShortcut[] Deserialize (string prefix, Action[] actions, RDEditorShortcut[] defaults) {
