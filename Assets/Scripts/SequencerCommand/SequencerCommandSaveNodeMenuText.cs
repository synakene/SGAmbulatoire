...
namespace PixelCrushers.DialogueSystem.SequencerCommands {
	...
	public class SequencerCommandSaveNodeMenuText : SequencerCommand {
		...
		public void Start() {
            ...
            string question = DialogueManager.CurrentConversationState.subtitle.dialogueEntry.MenuText;
            string goodAnswer = "";
            int idGoodAnswer = 0;
