...
namespace PixelCrushers.DialogueSystem.SequencerCommands {
	...
	public class SequencerCommandSetConv3 : SequencerCommand {

		public void Start() {
            //Cam move
            GameObject Cam = GameObject.Find("Main Camera");

            Vector3 NewCamPos = new Vector3(6.152f, 1.15f, 0.085f);
            Quaternion NewCamRot = Quaternion.Euler(6f, 293.411f, 0f);
